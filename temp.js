  ...
  return (
    <div className={`min-h-screen ${theme.bg} p-4`}>
      <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2 group/volume">
                      ...
                      <div
                        ref={volumeRef}
                        className="w-20 h-2 bg-white/20 rounded-full cursor-pointer opacity-0 group-hover/volume:opacity-100 transition-opacity"
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="relative">
                      ...
                      {showSettings && (
                        <div className="absolute bottom-full right-0 mb-2 bg-gray-900/90 backdrop-blur-sm rounded-lg p-2 min-w-32">
        ...
        {videoSrc && (
          <div className={`mt-8 ${theme.card} backdrop-blur-sm rounded-xl p-6 border border-gray-700`}>
            <h3 className="text-lg font-semibold text-white mb-4">Video Controls</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-300">
              <div><strong>Space:</strong> Play/Pause</div>
              <div><strong>←/→:</strong> Skip 10s</div>
